...
##########
# test
# test = pd.read_html('http://finance.naver.com/item/sise_day.nhn?code=011070&page=1', header=0)[0]  # 사이트막혀있음

# res = requests.get('http://finance.naver.com/item/sise.nhn?code=011070&page=1')  # iframe으로 들어가야함
# soup = BeautifulSoup(res.content,'html.parser')
# print('soup = \n{soup}'.format(soup=soup))
# table = soup.find_all('table')[0]
# test = pd.read_html(str(table))
